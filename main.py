    ...
    try:
        if zipfile.is_zipfile(full_path):
            ...
            for item in narrowed:
                ...
                if ((item.__contains__('cover') | item.__contains__('Cover') | item.__contains__(
                        "p000") | item.__contains__('000 ') | item.__contains__('-000') | item.__contains__('000a'))):
